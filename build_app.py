...
<body>
  <header>
    <div>
      ...
      <div class="subtle">원하는 섹션에서 특약을 선택한 뒤 가계약서에서 자동으로 합산된 문구를 확인하고 다운로드할 수 있습니다.</div>
    </div>
  ...
  <div class="layout">
    <nav>
      ...
      <details class="guide" open>
        <summary>간단 사용 설명서</summary>
        <div class="guide-body">
          <ol>
            <li>왼쪽 메뉴에서 필요한 특약 섹션을 엽니다.</li>
            <li>원하는 특약사항을 클릭하거나 체크합니다.</li>
            <li>마지막에 <strong>가계약서</strong> 섹션으로 이동합니다.</li>
            <li>가계약 정보를 입력하면 선택한 특약이 자동으로 특약사항에 추가됩니다.</li>
            <li>가계약서의 <strong>복사</strong>, <strong>인쇄</strong>, <strong>다운로드</strong> 버튼으로 저장합니다.</li>
          </ol>
          <div class="guide-note">선택 내용은 같은 브라우저 안에서 자동 연동됩니다.</div>
        </div>
      </details>
      <div id="menu"></div>
    </nav>
